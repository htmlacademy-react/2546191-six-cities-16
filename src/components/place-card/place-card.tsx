...
type PlaceCardProps = Omit<OfferPreview, 'location'|'city'|'id'>;


function PlaceCard({isPremium,previewImage,price,isFavorite,rating,title,type}:PlaceCardProps): JSX.Element {
  return(
